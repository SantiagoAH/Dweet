...
const char *ssid = "FAMILIA ARROYAVE";
const char *password = "3120202499";
...
void loop()
{
  ...
  String url = "/dweet/for/ucevaSantiago?temperatura=" + String(temperatura) + "&humedad=" + String(humedad) + "&indice=" + String(indice);
